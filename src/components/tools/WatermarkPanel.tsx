...
export function WatermarkPanel() {
  ...
  const apply = () => {
    ...
    notify("success", `${ids.length} sayfaya filigran eklendi.`);
  };
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <Section title="Görünüm">
        <Slider label="Boyut" value={size} suffix="pt" min={12} max={120} onChange={setSize} />
        ...
        />
        <Slider label="Açı" value={angle} suffix="°" min={-90} max={90} onChange={setAngle} />
      </Section>
